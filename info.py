...
# Bot Session Name
SESSION = environ.get('SESSION', 'sr_video_quality_bot')
...
STREAM_URL = environ.get("STREAM_URL", "https://sr-video-quality-2.onrender.com/")
...
LINK_URL = environ.get("LINK_URL", "https://sr-video-quality-2.onrender.com")
